...
object Compat {
  ...
  /**
   * Checks whether Do not Disturb is currently active. Will fall back to silent / vibrate on older
   * Android versions
   ...
   * @param channelId ID of the notification channel to check. Ignored on platforms below API26 and
   * can be left null to check whether notifications are enabled overall for this app.
