...
abstract class BasePreferenceChangeReceiver : WearableListenerService() {
    ...
    abstract fun onPreferenceChangeReceived(preferenceChangeEvents: DataEventBuffer?)

    override fun onDataChanged(dataEvents: DataEventBuffer?) {
        onPreferenceChangeReceived(dataEvents)
    }

    fun handlePreferenceChange(event: DataEvent) {
