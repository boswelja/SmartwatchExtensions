...
class ClearCacheActionFragmentTest {

    private lateinit var scenario: FragmentScenario<ClearCacheActionFragment>
    ...
    fun buttonOpensBottomSheet() {
        ...
        scenario.onFragment {
            ...
            assertThat(
                it.childFragmentManager.findFragmentByTag(ClearCacheBottomSheet::class.simpleName)
            ).isNotNull()
        }
    }
}
