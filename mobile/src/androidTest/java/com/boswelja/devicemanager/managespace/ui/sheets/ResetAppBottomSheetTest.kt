...
class ResetAppBottomSheetTest {

    private lateinit var scenario: FragmentScenario<ResetAppBottomSheet>
    ...
    fun uiFlowCompletes() {
        ...
        onView(withId(R.id.button)).check(matches(ViewMatchers.withText(R.string.button_finish)))
    }
}
