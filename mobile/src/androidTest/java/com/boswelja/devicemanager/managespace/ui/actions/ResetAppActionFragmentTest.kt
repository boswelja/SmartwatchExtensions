...
class ResetAppActionFragmentTest {

    private lateinit var scenario: FragmentScenario<ResetAppActionFragment>
    ...
    fun buttonOpensBottomSheet() {
        ...
        scenario.onFragment {
            ...
            assertThat(
                it.childFragmentManager.findFragmentByTag(ResetAppBottomSheet::class.simpleName)
            ).isNotNull()
        }
    }
}
