...
class BigItemIconOneLine(binding: CommonRecyclerviewItemIconOneLineBinding) :
    ...
    companion object {
        fun create(layoutInflater: LayoutInflater, parent: ViewGroup): BigItemIconOneLine {
            return BigItemIconOneLine(CommonRecyclerviewItemIconOneLineBinding
