...
class SettingsFragment :
    ...
    private fun setupBatterySyncPrefs() {
        findPreference<TwoStatePreference>(BATTERY_SYNC_ENABLED_KEY)!!.onPreferenceChangeListener =
            this
    ...
    private fun setupDnDSyncPrefs() {
        findPreference<TwoStatePreference>(DND_SYNC_TO_WATCH_KEY)!!.onPreferenceChangeListener =
            this

        findPreference<TwoStatePreference>(DND_SYNC_TO_PHONE_KEY)!!.onPreferenceChangeListener =
            this
