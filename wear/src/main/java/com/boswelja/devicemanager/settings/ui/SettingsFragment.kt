...
class SettingsFragment :
  ...
  private val interruptFilterAccessListener =
  ...
  override fun onPreferenceChange(preference: Preference?, newValue: Any?): Boolean {
    return when (val key = preference?.key
      ...
      BATTERY_SYNC_ENABLED_KEY, BATTERY_PHONE_CHARGE_NOTI_KEY, BATTERY_WATCH_CHARGE_NOTI_KEY -> {
  ...
  private fun setupBatterySyncPrefs() {
    findPreference<TwoStatePreference>(BATTERY_SYNC_ENABLED_KEY)!!.onPreferenceChangeListener = this

    findPreference<TwoStatePreference>(BATTERY_PHONE_CHARGE_NOTI_KEY)!!.onPreferenceChangeListener =
        this

    findPreference<TwoStatePreference>(BATTERY_WATCH_CHARGE_NOTI_KEY)!!.onPreferenceChangeListener =
        this
  }

  private fun setupDnDSyncPrefs() {
    findPreference<TwoStatePreference>(DND_SYNC_TO_WATCH_KEY)!!.onPreferenceChangeListener = this

    findPreference<TwoStatePreference>(DND_SYNC_TO_PHONE_KEY)!!.onPreferenceChangeListener = this

    findPreference<TwoStatePreference>(DND_SYNC_WITH_THEATER_KEY)!!.onPreferenceChangeListener =
        this
  }
